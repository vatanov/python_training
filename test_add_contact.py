...
def test_add_contact1(app):
    ...
    app.create_new_contact(Contact(firstname="qqqqq", middlename="eeeee", lastname="aaaaa", nickname="ffffff",
...
def test_add_contact2(app):
    app.login(username = "admin", password = "secret")
    app.create_new_contact(Contact(firstname="qaz", middlename="wsx", lastname="edcrfv", nickname="qwertyu",
